...
int main() {
    ...
    for (int t = 0; t < 3; t++) {
        ...
        inicio = clock();
        buscarLivroPorISBN(&biblioteca, isbnBusca, &resultado);
        fim = clock();
        tempo = (double)(fim - inicio) / CLOCKS_PER_SEC;
    ...
    do {
        ...
        switch (opcao) {
            case 1:
                ...
                cadastrarLivro(&biblioteca, novoLivro);
                break;
            ...
            case 3:
                ...
                emprestarLivro(&biblioteca, isbnBusca, usuario, data);
                break;
            ...
            case 4:
                ...
                devolverLivro(&biblioteca, isbnBusca);
                break;
